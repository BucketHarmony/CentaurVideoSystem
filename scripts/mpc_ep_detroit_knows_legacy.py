...
# Identity reel: sky on the intro (institutional/formal), magenta on the
# stakes line ("ICE is not new" — emotional weight), back to sky on the
# call ("stronger together" reads cooperative). CTA stays magenta.
CHIP_COLORS = {
    "hook":   C["sky_blue"],
...
def main():
    print("Building MPC Detroit Knows ICE (30s identity reel)...")
