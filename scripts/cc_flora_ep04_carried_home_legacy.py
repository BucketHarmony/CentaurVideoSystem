...
def generate_tts(text, output_path):
    """Generate TTS via ElevenLabs. Strip [tags] from text — they cause pauses
    in multilingual_v2. Instead, use voice_settings for style control."""
    # Strip leading [tag] — it causes ElevenLabs to pause/speak it
    clean = text
    if clean.startswith("["):
