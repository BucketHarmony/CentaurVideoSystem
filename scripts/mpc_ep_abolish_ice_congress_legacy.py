...
# Power ladder reel: chip color climbs the rungs of authority. Sky on Tlaib's
# legislation (institutional), magenta on Noem prosecution (consequence),
# sky on the chant (the people answering back), magenta on CTA.
CHIP_COLORS = {
    "hook":     C["sky_blue"],
...
def main():
    print("Building MPC Abolish ICE — From Congress to the Curb (30s)...")
